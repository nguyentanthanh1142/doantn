...
<body>
						...
						<div class="row">
							<div class="col-md-9">
								...
								<div class="form-group">
									<label>Tên ảnh bìa</label>
									<c:if test="${not empty banneritem}">
										<form:input class="form-control" type="text"
											path="banner_name" required="required"
											value="${ empty oldvalue.banner_name ? banneritem.banner_name: oldvalue.banner_name }" />
							...
							<div class="col-md-3">
								<div class="form-group">
									<label>Trạng thái</label><input type="hidden" id="status123"
										value="${banneritem.banner_status}">
	...
	<script type="text/javascript">
		...
		if (status == 2) {
			document.getElementById("banner_status").lastElementChild.selected = true;
		}
	</script>
</body>
</html>