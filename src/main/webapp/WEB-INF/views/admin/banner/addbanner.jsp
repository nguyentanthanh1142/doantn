			...
			<section class="content">
				...
				<div class="card">
					<div class="card-header">
						<h3 class="card-title">
							<strong class="text-uppercase text-danger">Thêm ảnh bìa</strong>
						</h3>
						...
						<div class="row">
							<div class="col-md-9">
								<div class="form-group">
									...
									<form:input class="form-control" type="text" path="banner_name"
										required="required"
										value="${ empty oldvalue.banner_name ? '': oldvalue.banner_name }" />
